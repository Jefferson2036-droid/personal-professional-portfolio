...
/**
 * Sets a body class reflecting which slide the viewer is on, so CSS can
 * hide the site footer (which otherwise overlays dense slide content)
 * except on the first and last slide where it belongs as chrome.
 *
 * Emits `is-first-slide`, `is-last-slide`, or `is-middle-slide` on <body>.
 */
